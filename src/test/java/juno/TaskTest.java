...
class TaskTest {
    ...
    public void testTodoTaskToString() {
        TodoTask todoTask = new TodoTask("Test Todo", false);
    ...
    public void testDeadlineTaskToString() {
        ...
        DeadlineTask deadlineTask = new DeadlineTask("Test Deadline", deadline, false);
    ...
    public void testEventTaskToString() {
        ...
        EventTask eventTask = new EventTask("Test Event", fromDate, toDate, false);
